...
async function redirectIfAuthenticated() {
    ...
    if (authenticated && (window.location.pathname.includes('login.html') || window.location.pathname.includes('register.html'))) {
...
async function redirectIfNotAuthenticated() {
    const authenticated = await isAuthenticated();
    if (!authenticated && window.location.pathname.includes('dashboard.html')) {
